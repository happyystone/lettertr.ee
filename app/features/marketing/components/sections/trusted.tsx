...
const logos = [
  { img: '/logos/logo-ispum-1.png' },
  { img: '/logos/logo-ispum-2.png' },
  { img: '/logos/logo-ispum-3.png' },
  { img: '/logos/logo-ispum-4.png' },
  { img: '/logos/logo-ispum-5.png' },
  { img: '/logos/logo-ispum-6.png' },
];
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center justify-center gap-6">
        <img width={180} height={180} className="rounded-full" alt="logo" src={img} />
      </div>
    </motion.figure>
  );
};
